...
const LabelDropdown = ({ }) => {
    ...
    return (
        <div className="relative inline-block text-left" ref={dropdownRef}>
            ...
            >
                <p className={`text-sm ${isOpen ? "text-white" : ""}`} >{selectedLabel}</p>

                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" className={`${isOpen ? "text-white" : "text-gray-600"}`}>
